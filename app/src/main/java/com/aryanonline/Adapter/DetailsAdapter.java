...
public class DetailsAdapter extends RecyclerView.Adapter<DetailsAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tv_title, tv_price, tv_total, tv_contetiy, tv_add, mrpPrice, tv_subcat_model, txHome;
        ...
        public ViewHolder(View view) {
            ...
            txHome = (TextView) view.findViewById(R.id.tx_home);
...
//                viewHolder.tv_total.setText("" + price * items );
        ...
        viewHolder.txHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                qty = qty + 1;
    ...
    class SendJsonData extends AsyncTask<String, String, String> {
        ...
        Session_management session_management = new Session_management(mactivity);
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                postDataParams.put("user_id", session_management.getUserDetails().get(BaseURL.KEY_ID));
