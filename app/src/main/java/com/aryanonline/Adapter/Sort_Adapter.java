...
public class Sort_Adapter  extends RecyclerView.Adapter<Sort_Adapter.ViewHolder> {
    ...
    private static final String TAG = "Sort_Adapter";
    private ArrayList<Sorted_Model> newSubList;
    ...
    public Sort_Adapter(Context mContext, ArrayList<Sorted_Model> subC_list) {
        context = mContext;
        newSubList = subC_list;
    }

    @Override
    public Sort_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(com.aryanonline.R.layout.new_sub_cat, parent, false);

        return new Sort_Adapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final Sort_Adapter.ViewHolder viewHolder, final int position) {
        Sorted_Model subCatModel = newSubList.get(position);
        ...
        viewHolder.wish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ConnectivityReceiver.isConnected()) {
                    new Sort_Adapter.SendJsonData().execute();
                }
